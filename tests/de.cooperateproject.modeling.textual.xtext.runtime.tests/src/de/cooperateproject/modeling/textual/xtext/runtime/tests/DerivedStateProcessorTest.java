...
public class DerivedStateProcessorTest {
    ...
    public void setUp() throws Exception {
        ...
        Injector injector = Guice.createInjector(new DerivedStateProcessorModule(initializerMocks, calculatorMocks, removerMocks));
    ...
    public void testRequirementOrderingInitializer() {
        ...
        IAtomicDerivedStateProcessor namedElementProcessor = ctrl.createMock("namedelement", IAtomicDerivedStateProcessor.class);
        ...
        expect(modelProcessor.getRequirements()).andReturn(Arrays.asList(Element.class, org.eclipse.uml2.uml.Package.class));
