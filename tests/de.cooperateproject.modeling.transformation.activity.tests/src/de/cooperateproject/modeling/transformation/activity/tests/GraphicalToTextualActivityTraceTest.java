...
public class GraphicalToTextualActivityTraceTest extends ActivityDirectionalTraceTransformationTestBase {
    ...
    private static final URI G2T_TRACE_TRANSFORMATION_URI = createTransformationURI(ActivityActivator.PLUGIN_ID,
            "Graphical_to_Textual_for_Activity_Trace.qvto");

    static {
        ActPackage.eINSTANCE.eClass();
    }
    
    public GraphicalToTextualActivityTraceTest() {
