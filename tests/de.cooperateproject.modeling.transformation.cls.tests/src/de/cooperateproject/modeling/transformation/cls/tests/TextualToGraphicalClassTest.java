...
public class TextualToGraphicalClassTest extends ClsDirectionalTransformationTestBase {
    ...
    @Test
    public void testClassCommentedPackage() throws Exception {
       testRegular("ClassDiagramCommentedPackage");
    }
