...
public class TextualToGraphicalSequenceTraceTest extends SequenceDirectionalTraceTransformationTestBase {
    ...
    private static final URI T2G_TRACE_TRANSFORMATION_URI = createTransformationURI(SequenceActivator.PLUGIN_ID,
