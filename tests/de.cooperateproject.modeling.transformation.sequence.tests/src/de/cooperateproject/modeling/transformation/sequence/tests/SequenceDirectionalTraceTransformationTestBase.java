...
public class SequenceDirectionalTraceTransformationTestBase extends DirectedTraceTransformationTestBase {

    
    protected SequenceDirectionalTraceTransformationTestBase(String sourceFileExtension, String targetFileExtension,
    ...
    public static void initTestSpecificMappings() throws Exception {
        SequenceDirectionalTransformationTestBase.initialize();
    }
