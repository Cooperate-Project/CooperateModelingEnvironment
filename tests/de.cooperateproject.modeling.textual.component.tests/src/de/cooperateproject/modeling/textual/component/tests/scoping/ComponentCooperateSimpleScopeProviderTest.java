package de.cooperateproject.modeling.textual.component.tests.scoping;
...
import de.cooperateproject.modeling.textual.component.component.ClassDiagram;
...
@InjectWith(ComponentCustomizedInjectorProvider.DefaultProvider.class)
public class ComponentCooperateSimpleScopeProviderTest extends AbstractComponentTest {
    ...
    public void testNestedNormalizing() throws Exception {
        ClassDiagram cd = loadClassDiagram(rs, "simple.component");
    ...
    private static Resource loadResource(ResourceSet rs, String name) throws IOException {
        ...
        Resource r = rs.createResource(resourceURI, "component");
