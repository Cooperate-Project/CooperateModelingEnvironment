...
public abstract class AbstractComponentCustomizedRuntimeModule extends ComponentRuntimeModule {
    ...
    protected static class DummyFactoryRegistry implements IAutomatedIssueResolutionFactoryRegistry {
        ...
        public Collection<EPackage> coveredPackages() {
            return Arrays.asList(de.cooperateproject.modeling.textual.component.component.ComponentPackage.eINSTANCE, TextualCommonsPackage.eINSTANCE);
        }
