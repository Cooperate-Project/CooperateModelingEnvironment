...
public interface DummyPackage extends EPackage {
     ...
     * @ordered
     */
    int REFERENCING_ELEMENT__APPLIED_STEREOTYPES = CONTAINABLE_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
	int REFERENCING_ELEMENT_FEATURE_COUNT = CONTAINABLE_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
	int REFERENCING_ELEMENT_OPERATION_COUNT = CONTAINABLE_OPERATION_COUNT + 1;
     ...
     * @ordered
     */
    int REFERENCING_ELEMENT2__APPLIED_STEREOTYPES = CONTAINABLE_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
	int REFERENCING_ELEMENT2_FEATURE_COUNT = CONTAINABLE_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
	int REFERENCING_ELEMENT2_OPERATION_COUNT = CONTAINABLE_OPERATION_COUNT + 1;
