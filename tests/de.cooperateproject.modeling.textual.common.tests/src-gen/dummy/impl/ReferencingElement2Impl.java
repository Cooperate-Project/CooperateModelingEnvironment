...
public class ReferencingElement2Impl extends CDOObjectImpl implements ReferencingElement2 {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
        ...
        if (baseClass == UMLReferencingElement.class) {
            switch (baseOperationID) {
                case TextualCommonsPackage.UML_REFERENCING_ELEMENT___GET_UML_PARENT_NAMESPACE: return DummyPackage.REFERENCING_ELEMENT2___GET_UML_PARENT_NAMESPACE;
                default: return -1;
            }
        }
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case DummyPackage.REFERENCING_ELEMENT2___GET_UML_PARENT_NAMESPACE:
