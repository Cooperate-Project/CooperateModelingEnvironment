 ...
 *   <li>{@link dummy.impl.ReferencingElement2Impl#getAppliedStereotypes <em>Applied Stereotypes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferencingElement2Impl extends CDOObjectImpl implements ReferencingElement2 {
    ...
    public EList<StereotypeApplication> getAppliedStereotypes() {
        return (EList<StereotypeApplication>)eDynamicGet(DummyPackage.REFERENCING_ELEMENT2__APPLIED_STEREOTYPES, TextualCommonsPackage.Literals.UML_REFERENCING_ELEMENT__APPLIED_STEREOTYPES, true, true);
    }
    ...
    public void unsetAppliedStereotypes() {
        eDynamicUnset(DummyPackage.REFERENCING_ELEMENT2__APPLIED_STEREOTYPES, TextualCommonsPackage.Literals.UML_REFERENCING_ELEMENT__APPLIED_STEREOTYPES);
    }
    ...
    public boolean isSetAppliedStereotypes() {
        return eDynamicIsSet(DummyPackage.REFERENCING_ELEMENT2__APPLIED_STEREOTYPES, TextualCommonsPackage.Literals.UML_REFERENCING_ELEMENT__APPLIED_STEREOTYPES);
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case DummyPackage.REFERENCING_ELEMENT2__APPLIED_STEREOTYPES:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == UMLReferencingElement.class) {
            switch (derivedFeatureID) {
                ...
                case DummyPackage.REFERENCING_ELEMENT2__APPLIED_STEREOTYPES: return TextualCommonsPackage.UML_REFERENCING_ELEMENT__APPLIED_STEREOTYPES;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == UMLReferencingElement.class) {
            switch (baseFeatureID) {
                ...
                case TextualCommonsPackage.UML_REFERENCING_ELEMENT__APPLIED_STEREOTYPES: return DummyPackage.REFERENCING_ELEMENT2__APPLIED_STEREOTYPES;
                default: return -1;
            }
        }
