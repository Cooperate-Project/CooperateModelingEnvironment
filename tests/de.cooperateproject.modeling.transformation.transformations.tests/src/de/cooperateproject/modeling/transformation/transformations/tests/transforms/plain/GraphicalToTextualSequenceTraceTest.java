...
public class GraphicalToTextualSequenceTraceTest extends TraceRecordTransformationTestBase {
    ...
    public void testNestedExecutions() throws Exception {
        test("SequenceNestedExecutionSpecification");
    }

    @Test
    public void testCombinedFragments() throws Exception {
        test("SequenceCombinedFragments");
    }

    @Test
    public void testCreationDestruction() throws Exception {
        test("SequenceCreationDestruction");
    }
