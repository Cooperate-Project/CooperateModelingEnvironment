...
public class ComponentSwitch<T1> extends Switch<T1> {
    ...
    protected T1 doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case ComponentPackage.CLASSIFIER: {
            ...
            case ComponentPackage.CLASS: {
                de.cooperateproject.modeling.textual.component.component.Class class_ = (de.cooperateproject.modeling.textual.component.component.Class)theEObject;
            ...
            case ComponentPackage.INTERFACE_PROVIDING_REQUIRING_ENTITY: {
     ...
     * @generated
     */
    public T1 caseClass(de.cooperateproject.modeling.textual.component.component.Class object) {
        return null;
    }
