...
/**
 * This is the action bar contributor for the Cmp model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CmpActionBarContributor
     ...
     * @generated
     */
    public CmpActionBarContributor() {
    ...
    public void contributeToToolBar(IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("cmp-settings"));
        toolBarManager.add(new Separator("cmp-additions"));
    }
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(ComponentEditorPlugin.INSTANCE.getString("_UI_CmpEditor_menu"), "de.cooperateproject.modeling.textual.cmp.cmpMenuID");
