...
public class UsecaseSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_System___LeftCurlyBracketKeyword_2_1_0_RightCurlyBracketKeyword_2_1_4__q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_System___LeftCurlyBracketKeyword_2_1_0_RightCurlyBracketKeyword_2_1_4__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getSystemAccess().getLeftCurlyBracketKeyword_2_1_0()), new TokenAlias(false, false, grammarAccess.getSystemAccess().getRightCurlyBracketKeyword_2_1_4()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_System___LeftCurlyBracketKeyword_2_1_0_RightCurlyBracketKeyword_2_1_4__q.equals(syntax))
				emit_System___LeftCurlyBracketKeyword_2_1_0_RightCurlyBracketKeyword_2_1_4__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_System___LeftCurlyBracketKeyword_2_1_0_RightCurlyBracketKeyword_2_1_4__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
