...
public class WorkbenchPreferenceErrorIndicator extends PreferencePage implements IWorkbenchPreferencePage {
	...
	private FieldEditor createErrorIndicatorComboField(Composite parent) {
		...
		FieldEditor errorIndicator = new ComboFieldEditor(PreferenceHandler.INSTANCE.getErrorIndicatorPreferenceStore(),
	...
	private void initPreferenceStore(FieldEditor field) {
