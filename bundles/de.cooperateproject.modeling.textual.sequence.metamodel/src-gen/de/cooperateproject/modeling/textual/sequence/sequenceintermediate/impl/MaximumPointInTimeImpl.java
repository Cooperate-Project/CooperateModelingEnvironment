...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Maximum Point In Time</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.cooperateproject.modeling.textual.sequence.sequenceintermediate.impl.MaximumPointInTimeImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MaximumPointInTimeImpl extends PointInTimeImpl implements MaximumPointInTime {
    /**
     ...
     * @generated
     */
    protected MaximumPointInTimeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return SequenceIntermediatePackage.Literals.MAXIMUM_POINT_IN_TIME;
    }
    ...
    public EList<PointInTime> getElements() {
        if (elements == null) {
            elements = new EObjectResolvingEList<PointInTime>(PointInTime.class, this, SequenceIntermediatePackage.MAXIMUM_POINT_IN_TIME__ELEMENTS);
        }
        return elements;
    }
    ...
    public int getTimeInternal() {
        ...
        final /*@Thrown*/ PointInTime last = (PointInTime)OrderedCollectionLastOperation.INSTANCE.evaluate(sortedBy);
        if (last == null) {
            throw new InvalidValueException("Null source for \'\'http://www.cooperateproject.de/modeling/textual/sequence/SequenceIntermediate\'::PointInTime::time\'");
        }
        final /*@Thrown*/ int time_0 = last.getTime();
        return time_0;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SequenceIntermediatePackage.MAXIMUM_POINT_IN_TIME__ELEMENTS:
                return getElements();
        }
    ...
    public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
        if (baseClass == PointInTime.class) {
            switch (baseOperationID) {
                case SequenceIntermediatePackage.POINT_IN_TIME___GET_TIME_INTERNAL: return SequenceIntermediatePackage.MAXIMUM_POINT_IN_TIME___GET_TIME_INTERNAL;
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case SequenceIntermediatePackage.MAXIMUM_POINT_IN_TIME___GET_TIME_INTERNAL:
                return getTimeInternal();
        }
        return super.eInvoke(operationID, arguments);
    }

} //MaximumPointInTimeImpl
