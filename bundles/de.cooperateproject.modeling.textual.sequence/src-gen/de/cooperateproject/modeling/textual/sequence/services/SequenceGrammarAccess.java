...
public class SequenceGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MessageElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cStandardMessageParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cResponseMessageParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		private final RuleCall cFoundMessageParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		private final RuleCall cLostMessageParserRuleCall_3 = (RuleCall)cAlternatives.eContents().get(3);
		private final RuleCall cCreateMessageParserRuleCall_4 = (RuleCall)cAlternatives.eContents().get(4);
		private final RuleCall cDestructionMessageParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		...
		//StandardMessage
		public RuleCall getStandardMessageParserRuleCall_0() { return cStandardMessageParserRuleCall_0; }
		
		//ResponseMessage
		public RuleCall getResponseMessageParserRuleCall_1() { return cResponseMessageParserRuleCall_1; }
		
		//FoundMessage
		public RuleCall getFoundMessageParserRuleCall_2() { return cFoundMessageParserRuleCall_2; }
		
		//LostMessage
		public RuleCall getLostMessageParserRuleCall_3() { return cLostMessageParserRuleCall_3; }
		
		//CreateMessage
		public RuleCall getCreateMessageParserRuleCall_4() { return cCreateMessageParserRuleCall_4; }
		
		//DestructionMessage
		public RuleCall getDestructionMessageParserRuleCall_5() { return cDestructionMessageParserRuleCall_5; }
	}
	public class ExplicitArrivalOccurenceReferenceElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cExplicitOccurenceSpecificationAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final CrossReference cExplicitOccurenceSpecificationExplicitArrivalOccurenceSpecificationCrossReference_2_0 = (CrossReference)cExplicitOccurenceSpecificationAssignment_2.eContents().get(0);
		private final RuleCall cExplicitOccurenceSpecificationExplicitArrivalOccurenceSpecificationIDTerminalRuleCall_2_0_1 = (RuleCall)cExplicitOccurenceSpecificationExplicitArrivalOccurenceSpecificationCrossReference_2_0.eContents().get(1);
		...
		//explicitOccurenceSpecification=[ExplicitArrivalOccurenceSpecification]
		public Assignment getExplicitOccurenceSpecificationAssignment_2() { return cExplicitOccurenceSpecificationAssignment_2; }
		
		//[ExplicitArrivalOccurenceSpecification]
		public CrossReference getExplicitOccurenceSpecificationExplicitArrivalOccurenceSpecificationCrossReference_2_0() { return cExplicitOccurenceSpecificationExplicitArrivalOccurenceSpecificationCrossReference_2_0; }
		
		//ID
		public RuleCall getExplicitOccurenceSpecificationExplicitArrivalOccurenceSpecificationIDTerminalRuleCall_2_0_1() { return cExplicitOccurenceSpecificationExplicitArrivalOccurenceSpecificationIDTerminalRuleCall_2_0_1; }
	...
	public class StandardMessageElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cSendEventAssignment_8 = (Assignment)cGroup.eContents().get(8);
		private final RuleCall cSendEventImplicitSendOccurenceSpecificationParserRuleCall_8_0 = (RuleCall)cSendEventAssignment_8.eContents().get(0);
		private final Alternatives cAlternatives_9 = (Alternatives)cGroup.eContents().get(9);
		private final Assignment cArrivalEventAssignment_9_0 = (Assignment)cAlternatives_9.eContents().get(0);
		private final RuleCall cArrivalEventExplicitArrivalOccurenceReferenceParserRuleCall_9_0_0 = (RuleCall)cArrivalEventAssignment_9_0.eContents().get(0);
		private final Assignment cArrivalEventAssignment_9_1 = (Assignment)cAlternatives_9.eContents().get(1);
		private final RuleCall cArrivalEventImplicitArrivalOccurenceSpecificationParserRuleCall_9_1_0 = (RuleCall)cArrivalEventAssignment_9_1.eContents().get(0);
		
		//StandardMessage:
		//	type=MessageType name=UnescapedString '(' left=[Actor|FQN] ',' right=[Actor|FQN] ')' ('as' alias=ID)?
		...
		public Assignment getSendEventAssignment_8() { return cSendEventAssignment_8; }
		
		//ImplicitSendOccurenceSpecification
		public RuleCall getSendEventImplicitSendOccurenceSpecificationParserRuleCall_8_0() { return cSendEventImplicitSendOccurenceSpecificationParserRuleCall_8_0; }
		...
		public Assignment getArrivalEventAssignment_9_0() { return cArrivalEventAssignment_9_0; }
		
		//ExplicitArrivalOccurenceReference
		public RuleCall getArrivalEventExplicitArrivalOccurenceReferenceParserRuleCall_9_0_0() { return cArrivalEventExplicitArrivalOccurenceReferenceParserRuleCall_9_0_0; }
		
		//arrivalEvent=ImplicitArrivalOccurenceSpecification
		public Assignment getArrivalEventAssignment_9_1() { return cArrivalEventAssignment_9_1; }
		
		//ImplicitArrivalOccurenceSpecification
		public RuleCall getArrivalEventImplicitArrivalOccurenceSpecificationParserRuleCall_9_1_0() { return cArrivalEventImplicitArrivalOccurenceSpecificationParserRuleCall_9_1_0; }
	}
	public class ResponseMessageElements extends AbstractParserRuleElementFinder {
		...
		//ResponseMessage:
		//	'reply' name=UnescapedString '(' (left=[Actor|FQN] | '_') ',' (right=[Actor|FQN] | '_') ')' ('as' alias=ID)?
		//	sendEvent=ImplicitSendOccurenceSpecification (arrivalEvent=ExplicitArrivalOccurenceReference |
		//	arrivalEvent=ImplicitArrivalOccurenceSpecification);
		@Override public ParserRule getRule() { return rule; }
	...
	public class FoundMessageElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cAliasAssignment_8_1 = (Assignment)cGroup_8.eContents().get(1);
		private final RuleCall cAliasIDTerminalRuleCall_8_1_0 = (RuleCall)cAliasAssignment_8_1.eContents().get(0);
		private final Assignment cArrivalEventAssignment_9 = (Assignment)cGroup.eContents().get(9);
		private final RuleCall cArrivalEventImplicitArrivalOccurenceSpecificationParserRuleCall_9_0 = (RuleCall)cArrivalEventAssignment_9.eContents().get(0);
		...
		//alias=ID
		public Assignment getAliasAssignment_8_1() { return cAliasAssignment_8_1; }
		
		//ID
		public RuleCall getAliasIDTerminalRuleCall_8_1_0() { return cAliasIDTerminalRuleCall_8_1_0; }
		
		//arrivalEvent=ImplicitArrivalOccurenceSpecification
		public Assignment getArrivalEventAssignment_9() { return cArrivalEventAssignment_9; }
		
		//ImplicitArrivalOccurenceSpecification
		public RuleCall getArrivalEventImplicitArrivalOccurenceSpecificationParserRuleCall_9_0() { return cArrivalEventImplicitArrivalOccurenceSpecificationParserRuleCall_9_0; }
	}
	public class LostMessageElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cAliasAssignment_8_1 = (Assignment)cGroup_8.eContents().get(1);
		private final RuleCall cAliasIDTerminalRuleCall_8_1_0 = (RuleCall)cAliasAssignment_8_1.eContents().get(0);
		private final Assignment cSendEventAssignment_9 = (Assignment)cGroup.eContents().get(9);
		private final RuleCall cSendEventImplicitSendOccurenceSpecificationParserRuleCall_9_0 = (RuleCall)cSendEventAssignment_9.eContents().get(0);
		
		//LostMessage Message:
		//	'lost' ('reply' {ResponseMessage} | {StandardMessage} type=MessageType) name=UnescapedString '(' left=[Actor|FQN] ','
		//	'_' ')' ('as' alias=ID)? sendEvent=ImplicitSendOccurenceSpecification;
		@Override public ParserRule getRule() { return rule; }
		...
		//sendEvent=ImplicitSendOccurenceSpecification
		public Assignment getSendEventAssignment_9() { return cSendEventAssignment_9; }
		
		//ImplicitSendOccurenceSpecification
		public RuleCall getSendEventImplicitSendOccurenceSpecificationParserRuleCall_9_0() { return cSendEventImplicitSendOccurenceSpecificationParserRuleCall_9_0; }
	}
	...
	public class ImplicitSendOccurenceSpecificationElements extends AbstractParserRuleElementFinder {
		...
		private final Action cImplicitMessageOccurenceSpecificationAction = (Action)rule.eContents().get(1);
		
		//ImplicitSendOccurenceSpecification ImplicitMessageOccurenceSpecification:
		//	{ImplicitMessageOccurenceSpecification};
		@Override public ParserRule getRule() { return rule; }
		
		//{ImplicitMessageOccurenceSpecification}
		public Action getImplicitMessageOccurenceSpecificationAction() { return cImplicitMessageOccurenceSpecificationAction; }
	}
	public class ImplicitArrivalOccurenceSpecificationElements extends AbstractParserRuleElementFinder {
		...
		//ImplicitArrivalOccurenceSpecification ImplicitMessageOccurenceSpecification:
		//	{ImplicitMessageOccurenceSpecification};
		@Override public ParserRule getRule() { return rule; }
