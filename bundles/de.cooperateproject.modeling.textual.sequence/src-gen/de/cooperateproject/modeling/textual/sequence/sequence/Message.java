 ...
 * </p>
 * <ul>
 *   <li>{@link de.cooperateproject.modeling.textual.sequence.sequence.Message#getType <em>Type</em>}</li>
...
public interface Message extends InteractionFragment
{
   ...
   * @see de.cooperateproject.modeling.textual.sequence.sequence.SequencePackage#getMessage_Type()
   * @model
   * @generated
   */
  MessageType getType();
  ...
  /**
   * Sets the value of the '{@link de.cooperateproject.modeling.textual.sequence.sequence.Message#getType <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
