...
public class ParallelImpl extends CombinedFragmentImpl implements Parallel
{
   ...
   * @ordered
   */
  protected EList<ParallelFragment> parallels;
   ...
   * @generated
   */
  public EList<ParallelFragment> getParallels()
  {
    if (parallels == null)
    {
      parallels = new EObjectContainmentEList<ParallelFragment>(ParallelFragment.class, this, SequencePackage.PARALLEL__PARALLELS);
    }
    return parallels;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case SequencePackage.PARALLEL__PARALLELS:
        getParallels().clear();
        getParallels().addAll((Collection<? extends ParallelFragment>)newValue);
        return;
    }
