...
import de.cooperateproject.modeling.textual.sequence.parser.antlr.SequenceParser;
import de.cooperateproject.modeling.textual.sequence.parser.antlr.internal.InternalSequenceLexer;
import de.cooperateproject.modeling.textual.sequence.scoping.SequenceScopeProvider;
import de.cooperateproject.modeling.textual.sequence.serializer.SequenceSemanticSequencer;
...
public abstract class AbstractSequenceRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "de/cooperateproject/modeling/textual/sequence/Sequence.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("de.cooperateproject.modeling.textual.sequence.Sequence");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("seq");
	}
	...
	public Class<? extends IGrammarAccess> bindIGrammarAccess() {
		return SequenceGrammarAccess.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISemanticSequencer> bindISemanticSequencer() {
		return SequenceSemanticSequencer.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISyntacticSequencer> bindISyntacticSequencer() {
		return SequenceSyntacticSequencer.class;
	}
	...
	public Class<? extends IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return SequenceAntlrTokenFileProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Class<? extends Lexer> bindLexer() {
		return InternalSequenceLexer.class;
	}
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalSequenceLexer> provideInternalSequenceLexer() {
		return LexerProvider.create(InternalSequenceLexer.class);
	}
	...
	public Class<? extends SequenceValidator> bindSequenceValidator() {
	...
	public Class<? extends IFormatter2> bindIFormatter2() {
		return SequenceFormatter.class;
	}
	...
	public Class<? extends IScopeProvider> bindIScopeProvider() {
		return SequenceScopeProvider.class;
	}
	...
	public Class<? extends IAutomatedIssueResolutionProvider> bindIAutomatedIssueResolutionProvider() {
		return SequenceAutomatedIssueResolutionProvider.class;
	}
