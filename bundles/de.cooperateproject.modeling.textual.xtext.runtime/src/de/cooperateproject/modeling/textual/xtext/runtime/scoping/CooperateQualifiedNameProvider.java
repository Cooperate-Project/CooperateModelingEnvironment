...
public class CooperateQualifiedNameProvider extends DefaultDeclarativeQualifiedNameProvider
    ...
    /**
     * Converts a UML stereotype to a qualified name.
     * 
     * Internal: This method does intentionally not use a qualified name as stereotypes are not shown with FQN
     * converter because the UML model elements might use another separator than
     * '.'.
     * 
     * @param element
     ...
     * @return The qualified name.
     */
    protected QualifiedName qualifiedName(Stereotype element) {
        return QualifiedName.create(element.getName());
    }
