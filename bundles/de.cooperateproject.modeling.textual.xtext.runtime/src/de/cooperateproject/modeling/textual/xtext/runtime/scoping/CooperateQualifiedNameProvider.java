...
public class CooperateQualifiedNameProvider extends DefaultDeclarativeQualifiedNameProvider
    ...
    protected QualifiedName qualifiedName(NamedElement element) {
        ...
        if (namespace != null) {
            QualifiedName rootName = getFullyQualifiedName(element.getNamespace());
            if (rootName != null && (element.getName() != null || element.getNameExpression() != null)) {
                return rootName
                        .append(element.getName() != null ? element.getName() : element.getNameExpression().getName());
            }
        }
