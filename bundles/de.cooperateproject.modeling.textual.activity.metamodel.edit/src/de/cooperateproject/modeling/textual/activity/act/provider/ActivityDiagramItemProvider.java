...
/**
 * This is the item provider adapter for a {@link de.cooperateproject.modeling.textual.activity.act.ActivityDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActivityDiagram_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActivityDiagram_title_feature", "_UI_ActivityDiagram_type"),
				 ActPackage.Literals.ACTIVITY_DIAGRAM__TITLE,
				 true,
				 false,
				 false,
	...
	protected void addRootPackagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActivityDiagram_rootPackage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActivityDiagram_rootPackage_feature", "_UI_ActivityDiagram_type"),
				 ActPackage.Literals.ACTIVITY_DIAGRAM__ROOT_PACKAGE,
				 true,
				 false,
				 true,
				 null,
