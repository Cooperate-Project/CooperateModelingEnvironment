		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOrderedFragmentContainerNoConditionAccess().getAlternatives(), "rule__OrderedFragmentContainerNoCondition__Alternatives");
					...
					put(grammarAccess.getStandardMessageAccess().getAlternatives_9(), "rule__StandardMessage__Alternatives_9");
					...
					put(grammarAccess.getResponseMessageAccess().getAlternatives_9(), "rule__ResponseMessage__Alternatives_9");
					put(grammarAccess.getLostMessageAccess().getAlternatives_1(), "rule__LostMessage__Alternatives_1");
					put(grammarAccess.getCreateMessageAccess().getAlternatives_9(), "rule__CreateMessage__Alternatives_9");
					put(grammarAccess.getDestructionMessageAccess().getAlternatives_9(), "rule__DestructionMessage__Alternatives_9");
					...
					put(grammarAccess.getOrderedFragmentContainerNoConditionAccess().getGroup_0(), "rule__OrderedFragmentContainerNoCondition__Group_0__0");
					put(grammarAccess.getOrderedFragmentContainerNoConditionAccess().getGroup_0_3(), "rule__OrderedFragmentContainerNoCondition__Group_0_3__0");
					...
					put(grammarAccess.getOrderedFragmentContainerWithConditionAccess().getGroup_1_0_3(), "rule__OrderedFragmentContainerWithCondition__Group_1_0_3__0");
					...
					put(grammarAccess.getOrderedFragmentContainerNoConditionMandatoryBracketsAccess().getGroup(), "rule__OrderedFragmentContainerNoConditionMandatoryBrackets__Group__0");
					...
					put(grammarAccess.getStandardMessageAccess().getGroup_7(), "rule__StandardMessage__Group_7__0");
					put(grammarAccess.getResponseMessageAccess().getGroup(), "rule__ResponseMessage__Group__0");
					put(grammarAccess.getResponseMessageAccess().getGroup_7(), "rule__ResponseMessage__Group_7__0");
					put(grammarAccess.getFoundMessageAccess().getGroup(), "rule__FoundMessage__Group__0");
					put(grammarAccess.getFoundMessageAccess().getGroup_8(), "rule__FoundMessage__Group_8__0");
					...
					put(grammarAccess.getLostMessageAccess().getGroup_8(), "rule__LostMessage__Group_8__0");
					put(grammarAccess.getCreateMessageAccess().getGroup(), "rule__CreateMessage__Group__0");
					put(grammarAccess.getCreateMessageAccess().getGroup_7(), "rule__CreateMessage__Group_7__0");
					put(grammarAccess.getDestructionMessageAccess().getGroup(), "rule__DestructionMessage__Group__0");
					put(grammarAccess.getDestructionMessageAccess().getGroup_7(), "rule__DestructionMessage__Group_7__0");
					put(grammarAccess.getDestructionOccurenceSpecificationAccess().getGroup(), "rule__DestructionOccurenceSpecification__Group__0");
					put(grammarAccess.getCombinedFragmentAccess().getGroup_1(), "rule__CombinedFragment__Group_1__0");
					put(grammarAccess.getCombinedFragmentAccess().getGroup_1_1(), "rule__CombinedFragment__Group_1_1__0");
					...
					put(grammarAccess.getOrderedFragmentContainerNoConditionAccess().getAliasAssignment_0_3_1(), "rule__OrderedFragmentContainerNoCondition__AliasAssignment_0_3_1");
					...
					put(grammarAccess.getOrderedFragmentContainerWithConditionAccess().getAliasAssignment_1_0_3_1(), "rule__OrderedFragmentContainerWithCondition__AliasAssignment_1_0_3_1");
					...
					put(grammarAccess.getOrderedFragmentContainerNoConditionMandatoryBracketsAccess().getFragmentsAssignment_1(), "rule__OrderedFragmentContainerNoConditionMandatoryBrackets__FragmentsAssignment_1");
					put(grammarAccess.getExplicitArrivalOccurenceReferenceAccess().getExplicitOccurenceSpecificationAssignment_2(), "rule__ExplicitArrivalOccurenceReference__ExplicitOccurenceSpecificationAssignment_2");
					...
					put(grammarAccess.getStandardMessageAccess().getAliasAssignment_7_1(), "rule__StandardMessage__AliasAssignment_7_1");
					put(grammarAccess.getStandardMessageAccess().getSendEventAssignment_8(), "rule__StandardMessage__SendEventAssignment_8");
					put(grammarAccess.getStandardMessageAccess().getArrivalEventAssignment_9_0(), "rule__StandardMessage__ArrivalEventAssignment_9_0");
					put(grammarAccess.getStandardMessageAccess().getArrivalEventAssignment_9_1(), "rule__StandardMessage__ArrivalEventAssignment_9_1");
					...
					put(grammarAccess.getResponseMessageAccess().getAliasAssignment_7_1(), "rule__ResponseMessage__AliasAssignment_7_1");
					put(grammarAccess.getResponseMessageAccess().getSendEventAssignment_8(), "rule__ResponseMessage__SendEventAssignment_8");
					put(grammarAccess.getResponseMessageAccess().getArrivalEventAssignment_9_0(), "rule__ResponseMessage__ArrivalEventAssignment_9_0");
					put(grammarAccess.getResponseMessageAccess().getArrivalEventAssignment_9_1(), "rule__ResponseMessage__ArrivalEventAssignment_9_1");
					...
					put(grammarAccess.getFoundMessageAccess().getAliasAssignment_8_1(), "rule__FoundMessage__AliasAssignment_8_1");
					put(grammarAccess.getFoundMessageAccess().getArrivalEventAssignment_9(), "rule__FoundMessage__ArrivalEventAssignment_9");
					...
					put(grammarAccess.getLostMessageAccess().getAliasAssignment_8_1(), "rule__LostMessage__AliasAssignment_8_1");
					put(grammarAccess.getLostMessageAccess().getSendEventAssignment_9(), "rule__LostMessage__SendEventAssignment_9");
					...
					put(grammarAccess.getCreateMessageAccess().getAliasAssignment_7_1(), "rule__CreateMessage__AliasAssignment_7_1");
					put(grammarAccess.getCreateMessageAccess().getSendEventAssignment_8(), "rule__CreateMessage__SendEventAssignment_8");
					put(grammarAccess.getCreateMessageAccess().getArrivalEventAssignment_9_0(), "rule__CreateMessage__ArrivalEventAssignment_9_0");
					put(grammarAccess.getCreateMessageAccess().getArrivalEventAssignment_9_1(), "rule__CreateMessage__ArrivalEventAssignment_9_1");
					...
					put(grammarAccess.getDestructionMessageAccess().getAliasAssignment_7_1(), "rule__DestructionMessage__AliasAssignment_7_1");
					put(grammarAccess.getDestructionMessageAccess().getSendEventAssignment_8(), "rule__DestructionMessage__SendEventAssignment_8");
					put(grammarAccess.getDestructionMessageAccess().getArrivalEventAssignment_9_0(), "rule__DestructionMessage__ArrivalEventAssignment_9_0");
					put(grammarAccess.getDestructionMessageAccess().getArrivalEventAssignment_9_1(), "rule__DestructionMessage__ArrivalEventAssignment_9_1");
					...
					put(grammarAccess.getCombinedFragmentAccess().getAliasAssignment_1_1_1(), "rule__CombinedFragment__AliasAssignment_1_1_1");
					...
					put(grammarAccess.getCriticalAccess().getRegionAssignment_1(), "rule__Critical__RegionAssignment_1");
