...
public abstract class TypedConnectorImpl<T extends DirectedRelationship> extends ElementImpl implements TypedConnector<T> {
    ...
    public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
        if (baseClass == UMLReferencingElement.class) {
            switch (baseOperationID) {
                case TextualCommonsPackage.UML_REFERENCING_ELEMENT___GET_UML_PARENT_NAMESPACE: return ClsPackage.TYPED_CONNECTOR___GET_UML_PARENT_NAMESPACE;
                default: return -1;
            }
        }
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case ClsPackage.TYPED_CONNECTOR___GET_UML_PARENT_NAMESPACE:
