...
import de.cooperateproject.modeling.textual.activity.derivedstate.calculator.ActDerivedStateElementComparator;
import de.cooperateproject.modeling.textual.activity.formatting2.ActFormatter;
import de.cooperateproject.modeling.textual.activity.issues.ActAutomatedIssueResolutionProvider;
import de.cooperateproject.modeling.textual.activity.parser.antlr.ActAntlrTokenFileProvider;
import de.cooperateproject.modeling.textual.activity.parser.antlr.ActParser;
import de.cooperateproject.modeling.textual.activity.parser.antlr.internal.InternalActLexer;
import de.cooperateproject.modeling.textual.activity.scoping.ActScopeProvider;
import de.cooperateproject.modeling.textual.activity.serializer.ActSemanticSequencer;
import de.cooperateproject.modeling.textual.activity.serializer.ActSyntacticSequencer;
import de.cooperateproject.modeling.textual.activity.services.ActGrammarAccess;
import de.cooperateproject.modeling.textual.activity.services.ActValueConverter;
import de.cooperateproject.modeling.textual.activity.validation.ActValidator;
...
/**
 * Manual modifications go to {@link ActRuntimeModule}.
 */
...
public abstract class AbstractActRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "de/cooperateproject/modeling/textual/activity/Act.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("de.cooperateproject.modeling.textual.activity.Act");
	}
	...
	public Class<? extends IGrammarAccess> bindIGrammarAccess() {
		return ActGrammarAccess.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISemanticSequencer> bindISemanticSequencer() {
		return ActSemanticSequencer.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISyntacticSequencer> bindISyntacticSequencer() {
		return ActSyntacticSequencer.class;
	}
	...
	public Class<? extends IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return ActAntlrTokenFileProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Class<? extends Lexer> bindLexer() {
		return InternalActLexer.class;
	}
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalActLexer> provideInternalActLexer() {
		return LexerProvider.create(InternalActLexer.class);
	}
	...
	public Class<? extends ActValidator> bindActValidator() {
		return ActValidator.class;
	}
	...
	public Class<? extends IAutomatedIssueResolutionProvider> bindIAutomatedIssueResolutionProvider() {
		return ActAutomatedIssueResolutionProvider.class;
	}
	...
	public Class<? extends IDerivedStateComputerSorter> bindIDerivedStateComputerSorter() {
		return ActDerivedStateElementComparator.class;
	}
	...
	public Class<? extends IValueConverterService> bindIValueConverterService() {
		return ActValueConverter.class;
	}
