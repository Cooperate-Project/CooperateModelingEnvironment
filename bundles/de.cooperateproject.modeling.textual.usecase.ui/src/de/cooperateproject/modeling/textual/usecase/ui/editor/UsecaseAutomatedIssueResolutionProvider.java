package de.cooperateproject.modeling.textual.usecase.ui.editor;
...
public class UsecaseAutomatedIssueResolutionProvider implements IAutomatedIssueResolutionProvider {

    private static final Set<String> RELEVANT_CODES = Sets.newHashSet(UsecaseValidator.MISSING_UML_REFERENCE);
