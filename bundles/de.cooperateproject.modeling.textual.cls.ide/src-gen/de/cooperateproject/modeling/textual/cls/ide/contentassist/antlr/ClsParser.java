		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getClassAccess().getGroup_3_0_1(), "rule__Class__Group_3_0_1__0");
					...
					put(grammarAccess.getInterfaceAccess().getGroup_2_0_1(), "rule__Interface__Group_2_0_1__0");
					...
					put(grammarAccess.getClassAccess().getAliasExpressionAssignment_3_0_1_1(), "rule__Class__AliasExpressionAssignment_3_0_1_1");
					put(grammarAccess.getClassAccess().getReferencedElementAssignment_3_1_0(), "rule__Class__ReferencedElementAssignment_3_1_0");
					put(grammarAccess.getClassAccess().getAliasExpressionAssignment_3_1_2(), "rule__Class__AliasExpressionAssignment_3_1_2");
					...
					put(grammarAccess.getInterfaceAccess().getAliasExpressionAssignment_2_0_1_1(), "rule__Interface__AliasExpressionAssignment_2_0_1_1");
					put(grammarAccess.getInterfaceAccess().getReferencedElementAssignment_2_1_0(), "rule__Interface__ReferencedElementAssignment_2_1_0");
					put(grammarAccess.getInterfaceAccess().getAliasExpressionAssignment_2_1_2(), "rule__Interface__AliasExpressionAssignment_2_1_2");
