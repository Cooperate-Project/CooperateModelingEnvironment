		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getInterfaceAccess().getAlternatives_4(), "rule__Interface__Alternatives_4");
					...
					put(grammarAccess.getClassAccess().getGroup_5_1(), "rule__Class__Group_5_1__0");
					...
					put(grammarAccess.getXtextAssociationAccess().getGroup_6(), "rule__XtextAssociation__Group_6__0");
					...
					put(grammarAccess.getXtextAssociationAccess().getGroup_9(), "rule__XtextAssociation__Group_9__0");
					put(grammarAccess.getXtextAssociationAccess().getGroup_9_3(), "rule__XtextAssociation__Group_9_3__0");
					...
					put(grammarAccess.getStereotypeApplicationAccess().getGroup(), "rule__StereotypeApplication__Group__0");
					put(grammarAccess.getStereotypeApplicationAccess().getGroup_3(), "rule__StereotypeApplication__Group_3__0");
					put(grammarAccess.getStereotypeApplicationAccess().getGroup_3_2(), "rule__StereotypeApplication__Group_3_2__0");
					...
					put(grammarAccess.getPackageAccess().getAppliedStereotypesAssignment_2(), "rule__Package__AppliedStereotypesAssignment_2");
					...
					put(grammarAccess.getClassAccess().getAppliedStereotypesAssignment_4(), "rule__Class__AppliedStereotypesAssignment_4");
					put(grammarAccess.getClassAccess().getCommentsAssignment_5_0(), "rule__Class__CommentsAssignment_5_0");
					put(grammarAccess.getClassAccess().getCommentsAssignment_5_1_1(), "rule__Class__CommentsAssignment_5_1_1");
					put(grammarAccess.getClassAccess().getMembersAssignment_5_1_2(), "rule__Class__MembersAssignment_5_1_2");
					...
					put(grammarAccess.getInterfaceAccess().getAppliedStereotypesAssignment_3(), "rule__Interface__AppliedStereotypesAssignment_3");
					put(grammarAccess.getInterfaceAccess().getCommentsAssignment_4_0(), "rule__Interface__CommentsAssignment_4_0");
					put(grammarAccess.getInterfaceAccess().getCommentsAssignment_4_1_1(), "rule__Interface__CommentsAssignment_4_1_1");
					put(grammarAccess.getInterfaceAccess().getMembersAssignment_4_1_2(), "rule__Interface__MembersAssignment_4_1_2");
					...
					put(grammarAccess.getAttributeAccess().getAppliedStereotypesAssignment_6(), "rule__Attribute__AppliedStereotypesAssignment_6");
					...
					put(grammarAccess.getMethodAccess().getAppliedStereotypesAssignment_4(), "rule__Method__AppliedStereotypesAssignment_4");
					...
					put(grammarAccess.getParameterAccess().getAppliedStereotypesAssignment_1(), "rule__Parameter__AppliedStereotypesAssignment_1");
					...
					put(grammarAccess.getXtextAssociationAccess().getAppliedStereotypesAssignment_3(), "rule__XtextAssociation__AppliedStereotypesAssignment_3");
					put(grammarAccess.getXtextAssociationAccess().getMemberEndTypesAssignment_5(), "rule__XtextAssociation__MemberEndTypesAssignment_5");
					put(grammarAccess.getXtextAssociationAccess().getMemberEndTypesAssignment_6_1(), "rule__XtextAssociation__MemberEndTypesAssignment_6_1");
					put(grammarAccess.getXtextAssociationAccess().getMemberEndNamesAssignment_8_2(), "rule__XtextAssociation__MemberEndNamesAssignment_8_2");
					put(grammarAccess.getXtextAssociationAccess().getMemberEndNamesAssignment_8_3_1(), "rule__XtextAssociation__MemberEndNamesAssignment_8_3_1");
					put(grammarAccess.getXtextAssociationAccess().getMemberEndCardinalitiesAssignment_9_2(), "rule__XtextAssociation__MemberEndCardinalitiesAssignment_9_2");
					put(grammarAccess.getXtextAssociationAccess().getMemberEndCardinalitiesAssignment_9_3_1(), "rule__XtextAssociation__MemberEndCardinalitiesAssignment_9_3_1");
					put(grammarAccess.getXtextAssociationAccess().getCommentsAssignment_10(), "rule__XtextAssociation__CommentsAssignment_10");
					...
					put(grammarAccess.getStereotypeApplicationAccess().getStereotypeAssignment_1(), "rule__StereotypeApplication__StereotypeAssignment_1");
					put(grammarAccess.getStereotypeApplicationAccess().getValuesAssignment_3_1(), "rule__StereotypeApplication__ValuesAssignment_3_1");
					put(grammarAccess.getStereotypeApplicationAccess().getValuesAssignment_3_2_1(), "rule__StereotypeApplication__ValuesAssignment_3_2_1");
