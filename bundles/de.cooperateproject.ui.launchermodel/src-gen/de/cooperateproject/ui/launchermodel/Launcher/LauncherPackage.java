...
public interface LauncherPackage extends EPackage {
	...
	/**
     * The operation id for the '<em>Get Concrete Syntax Model</em>' operation.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
    int DIAGRAM___GET_CONCRETE_SYNTAX_MODEL__CLASS = 0;
	...
	/**
     * The meta object id for the '<em>Concrete Syntax Type Not Available Exception Wrapper</em>' data type.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.cooperateproject.ui.launchermodel.helper.ConcreteSyntaxTypeNotAvailableException
     * @see de.cooperateproject.ui.launchermodel.Launcher.impl.LauncherPackageImpl#getConcreteSyntaxTypeNotAvailableExceptionWrapper()
     * @generated
     */
    int CONCRETE_SYNTAX_TYPE_NOT_AVAILABLE_EXCEPTION_WRAPPER = 4;
	...
	/**
     * Returns the meta object for the '{@link de.cooperateproject.ui.launchermodel.Launcher.Diagram#getConcreteSyntaxModel(java.lang.Class) <em>Get Concrete Syntax Model</em>}' operation.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the '<em>Get Concrete Syntax Model</em>' operation.
     * @see de.cooperateproject.ui.launchermodel.Launcher.Diagram#getConcreteSyntaxModel(java.lang.Class)
     * @generated
     */
    EOperation getDiagram__GetConcreteSyntaxModel__Class();
	...
	/**
     * Returns the meta object for data type '{@link de.cooperateproject.ui.launchermodel.helper.ConcreteSyntaxTypeNotAvailableException <em>Concrete Syntax Type Not Available Exception Wrapper</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for data type '<em>Concrete Syntax Type Not Available Exception Wrapper</em>'.
     * @see de.cooperateproject.ui.launchermodel.helper.ConcreteSyntaxTypeNotAvailableException
     * @model instanceClass="de.cooperateproject.ui.launchermodel.helper.ConcreteSyntaxTypeNotAvailableException"
     * @generated
     */
    EDataType getConcreteSyntaxTypeNotAvailableExceptionWrapper();
	...
	interface Literals {
		...
		/**
         * The meta object literal for the '<em><b>Get Concrete Syntax Model</b></em>' operation.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @generated
         */
        EOperation DIAGRAM___GET_CONCRETE_SYNTAX_MODEL__CLASS = eINSTANCE.getDiagram__GetConcreteSyntaxModel__Class();
        ...
        /**
         * The meta object literal for the '<em>Concrete Syntax Type Not Available Exception Wrapper</em>' data type.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @see de.cooperateproject.ui.launchermodel.helper.ConcreteSyntaxTypeNotAvailableException
         * @see de.cooperateproject.ui.launchermodel.Launcher.impl.LauncherPackageImpl#getConcreteSyntaxTypeNotAvailableExceptionWrapper()
         * @generated
         */
        EDataType CONCRETE_SYNTAX_TYPE_NOT_AVAILABLE_EXCEPTION_WRAPPER = eINSTANCE.getConcreteSyntaxTypeNotAvailableExceptionWrapper();
