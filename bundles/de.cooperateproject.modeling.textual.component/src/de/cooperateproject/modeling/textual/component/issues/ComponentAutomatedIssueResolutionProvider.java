...
public class ComponentAutomatedIssueResolutionProvider extends AutomatedIssueResolutionProviderBase {
    ...
    protected Collection<IAutomatedIssueResolutionFactory> findResolutionFactories(String issueCode) {
    	...
    	foundFactories.addAll(registry.findFactories(Collections.singletonList(de.cooperateproject.modeling.textual.component.cmp.CmpPackage.eINSTANCE), issueCode));
