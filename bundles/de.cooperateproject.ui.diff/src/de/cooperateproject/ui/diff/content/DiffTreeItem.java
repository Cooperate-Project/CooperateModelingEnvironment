...
public class DiffTreeItem {
	...
	private final Object object; // This is the original object (of this one)
									// from the EMF Containment Hierarchy.
	private DiffTreeItem parent;
	private DifferenceKind kind; // Showing if the item has changed in this
									// commit or not. In latter case it's null.

	/**
	 * Constructs a new DiffTreeItem of the given object (original object from
	 * EMF Containment Hierarchy).
	 * 
	 * @param object
	...
	/**
	 * Returns a list with all direct and indirect children of this
	 * diffTreeItem.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the original object from EMF Containment Hierarchy that
	 * corresponds to this diffTreeItem.
	 * 
	 * @return
	 */
	...
	/**
	 * Sets the DifferenceKind of this diffTreeItem. This is important, so we
	 * know, if this explicit item has been changed in the commit of the
	 * diagram.
	 * 
	 * @param kind
	 */
	 ...
	 * 
	 * @return The differenceKind of this diffTreeItem, null if it hasn't
	 *         changed
	 */
