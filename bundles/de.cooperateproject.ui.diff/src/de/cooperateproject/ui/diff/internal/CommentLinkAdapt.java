...
/**
 * This class finds the cooperate-internal object corresponding to the comment's
 * commented element.
 * 
 * @author Jasmin
 *
...
public class CommentLinkAdapt {
	...
	/**
	 * The view has to be set first (done by CommitManager) in order to be
	 * functional. Finds and returns the cooperate-internal object of the
	 * comment's commented element.
	 * 
	 * @param commentLink
	 *            the commentLink to be examined
