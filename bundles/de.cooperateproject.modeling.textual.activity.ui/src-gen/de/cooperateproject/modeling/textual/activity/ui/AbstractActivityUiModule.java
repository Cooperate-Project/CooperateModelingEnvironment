...
/**
 * Manual modifications go to {de.cooperateproject.modeling.textual.activity.ui.ActivityUiModule}
 */
@SuppressWarnings("all")
public abstract class AbstractActivityUiModule extends org.eclipse.xtext.ui.DefaultUiModule {
	
	public AbstractActivityUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ide.LexerIdeBindings.HIGHLIGHTING)).to(de.cooperateproject.modeling.textual.activity.parser.antlr.internal.InternalActivityLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return de.cooperateproject.modeling.textual.activity.ui.labeling.ActivityLabelProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.labeling.LabelProviderFragment
	public void configureResourceUIServiceLabelProvider(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.jface.viewers.ILabelProvider.class).annotatedWith(org.eclipse.xtext.ui.resource.ResourceServiceDescriptionLabelProvider.class).to(de.cooperateproject.modeling.textual.activity.ui.labeling.ActivityDescriptionLabelProvider.class);
	}

	// contributed by org.eclipse.xtext.ui.generator.outline.OutlineTreeProviderFragment
	public Class<? extends org.eclipse.xtext.ui.editor.outline.IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return de.cooperateproject.modeling.textual.activity.ui.outline.ActivityOutlineTreeProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.quickfix.IssueResolutionProvider> bindIssueResolutionProvider() {
		return de.cooperateproject.modeling.textual.activity.ui.quickfix.ActivityQuickfixProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.contentAssist.ContentAssistFragment
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return de.cooperateproject.modeling.textual.activity.ui.contentassist.ActivityProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ide.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return de.cooperateproject.modeling.textual.activity.ide.contentassist.antlr.ActivityParser.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(de.cooperateproject.modeling.textual.activity.ide.contentassist.antlr.internal.InternalActivityLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(de.cooperateproject.modeling.textual.activity.ide.contentassist.antlr.internal.InternalActivityLexer.class));
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ide.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ide.LexerIdeBindings.CONTENT_ASSIST)).to(de.cooperateproject.modeling.textual.activity.ide.contentassist.antlr.internal.InternalActivityLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.ide.editor.partialEditing.IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return de.cooperateproject.modeling.textual.activity.ide.contentassist.antlr.PartialActivityContentAssistParser.class;
	}
	...
	public Class<? extends org.eclipse.emf.compare.match.eobject.ProximityEObjectMatcher.DistanceFunction> bindProximityEObjectMatcher$DistanceFunction() {
		return de.cooperateproject.modeling.textual.activity.ui.cdoxtext.ActivityDistanceFunction.class;
	}
