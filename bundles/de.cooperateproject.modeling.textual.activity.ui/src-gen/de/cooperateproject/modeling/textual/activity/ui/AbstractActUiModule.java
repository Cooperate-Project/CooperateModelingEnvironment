...
import de.cooperateproject.modeling.textual.activity.ide.contentassist.antlr.PartialActContentAssistParser;
import de.cooperateproject.modeling.textual.activity.ide.contentassist.antlr.internal.InternalActLexer;
import de.cooperateproject.modeling.textual.activity.ui.cdoxtext.ActDistanceFunction;
import de.cooperateproject.modeling.textual.activity.ui.cdoxtext.ActMatchEngineFactory;
import de.cooperateproject.modeling.textual.activity.ui.contentassist.ActProposalProvider;
import de.cooperateproject.modeling.textual.activity.ui.labeling.ActDescriptionLabelProvider;
import de.cooperateproject.modeling.textual.activity.ui.labeling.ActLabelProvider;
import de.cooperateproject.modeling.textual.activity.ui.outline.ActOutlineTreeProvider;
import de.cooperateproject.modeling.textual.activity.ui.quickfix.ActQuickfixProvider;
...
/**
 * Manual modifications go to {@link ActUiModule}.
 */
...
public abstract class AbstractActUiModule extends DefaultUiModule {
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(de.cooperateproject.modeling.textual.activity.parser.antlr.internal.InternalActLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalActLexer.class).toProvider(LexerProvider.create(InternalActLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return ActLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(ActDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return ActOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return ActQuickfixProvider.class;
	}
	...
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return ActProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialActContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Act Compare");
	}
	...
	public Class<? extends Factory> bindFactory() {
		return ActMatchEngineFactory.class;
	}
	
	// contributed by net.winklerweb.cdoxtext.generator.emfcompare.EMFCompareMatcherFragment2
	public Class<? extends DistanceFunction> bindDistanceFunction() {
		return ActDistanceFunction.class;
	}
