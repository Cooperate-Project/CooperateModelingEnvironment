...
/**
 * This is the item provider adapter for a {@link de.cooperateproject.modeling.textual.cmp.cmp.RootPackage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootPackageItemProvider extends PackageBaseItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(CmpPackage.Literals.ROOT_PACKAGE__RELATIONS);
            childrenFeatures.add(CmpPackage.Literals.ROOT_PACKAGE__CLASSIFIERS);
        }
        ...
        newChildDescriptors.add
            (createChildParameter
                (TextualCommonsPackage.Literals.PACKAGE_BASE__PACKAGES,
                 CmpFactory.eINSTANCE.createRootPackage()));

        newChildDescriptors.add
            (createChildParameter
                (CmpPackage.Literals.ROOT_PACKAGE__RELATIONS,
                 CmpFactory.eINSTANCE.createGeneralization()));

        newChildDescriptors.add
            (createChildParameter
                (CmpPackage.Literals.ROOT_PACKAGE__RELATIONS,
                 CmpFactory.eINSTANCE.createAbstraction()));

        newChildDescriptors.add
            (createChildParameter
                (CmpPackage.Literals.ROOT_PACKAGE__RELATIONS,
                 CmpFactory.eINSTANCE.createManifestation()));

        newChildDescriptors.add
            (createChildParameter
                (CmpPackage.Literals.ROOT_PACKAGE__RELATIONS,
                 CmpFactory.eINSTANCE.createSubstitution()));

        newChildDescriptors.add
            (createChildParameter
                (CmpPackage.Literals.ROOT_PACKAGE__RELATIONS,
                 CmpFactory.eINSTANCE.createDependency()));

        newChildDescriptors.add
            (createChildParameter
                (CmpPackage.Literals.ROOT_PACKAGE__CLASSIFIERS,
