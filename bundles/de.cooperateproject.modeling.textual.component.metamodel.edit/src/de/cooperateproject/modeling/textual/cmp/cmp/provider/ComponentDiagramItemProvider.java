...
/**
 * This is the item provider adapter for a {@link de.cooperateproject.modeling.textual.cmp.cmp.ComponentDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentDiagramItemProvider 
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ComponentDiagram_title_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ComponentDiagram_title_feature", "_UI_ComponentDiagram_type"),
                 CmpPackage.Literals.COMPONENT_DIAGRAM__TITLE,
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(CmpPackage.Literals.COMPONENT_DIAGRAM__ROOTPACKAGE);
        }
    ...
    public String getText(Object object) {
        String label = ((ComponentDiagram)object).getTitle();
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (CmpPackage.Literals.COMPONENT_DIAGRAM__ROOTPACKAGE,
