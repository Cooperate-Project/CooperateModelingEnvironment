...
import de.cooperateproject.modeling.textual.cls.ide.contentassist.antlr.ClsParser;
import de.cooperateproject.modeling.textual.cls.ide.contentassist.antlr.PartialClsContentAssistParser;
import de.cooperateproject.modeling.textual.cls.ide.contentassist.antlr.internal.InternalClsLexer;
import de.cooperateproject.modeling.textual.cls.ui.cdoxtext.ClsDistanceFunction;
import de.cooperateproject.modeling.textual.cls.ui.cdoxtext.ClsMatchEngineFactory;
import de.cooperateproject.modeling.textual.cls.ui.contentassist.ClsProposalProvider;
import de.cooperateproject.modeling.textual.cls.ui.labeling.ClsDescriptionLabelProvider;
import de.cooperateproject.modeling.textual.cls.ui.labeling.ClsLabelProvider;
import de.cooperateproject.modeling.textual.cls.ui.outline.ClsOutlineTreeProvider;
...
/**
 * Manual modifications go to {@link ClsUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractClsUiModule extends DefaultUiModule {
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalClsLexer.class).toProvider(LexerProvider.create(InternalClsLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return ClsLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(ClsDescriptionLabelProvider.class);
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialClsContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Cls Compare");
	}
	...
	public Class<? extends Factory> bindFactory() {
		return ClsMatchEngineFactory.class;
	}
	
	// contributed by net.winklerweb.cdoxtext.generator.emfcompare.EMFCompareMatcherFragment2
	public Class<? extends DistanceFunction> bindDistanceFunction() {
		return ClsDistanceFunction.class;
	}
