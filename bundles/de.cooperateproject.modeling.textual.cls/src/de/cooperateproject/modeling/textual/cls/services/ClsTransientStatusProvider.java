...
public class ClsTransientStatusProvider implements ITransientStatusProvider {
    ...
    private static final Set<EStructuralFeature> NON_TRANSIENT_FEATURES = new HashSet<>(Arrays.asList(
            ClsPackage.Literals.XTEXT_ASSOCIATION__MEMBER_END_CARDINALITIES,
            ...
            ClsPackage.Literals.XTEXT_ASSOCIATION__TWO_SIDE_BIDIRECTIONALITY, ClsPackage.Literals.CLASS__ABSTRACT,
            ClsPackage.Literals.XTEXT_ASSOCIATION_MEMBER_END_REFERENCED_TYPE__TYPE, ClsPackage.Literals.MEMBER__STATIC,
            ClsPackage.Literals.TYPED_CONNECTOR__LEFT, ClsPackage.Literals.TYPED_CONNECTOR__RIGHT,
            ClsPackage.Literals.PROPERTY__TYPE));
