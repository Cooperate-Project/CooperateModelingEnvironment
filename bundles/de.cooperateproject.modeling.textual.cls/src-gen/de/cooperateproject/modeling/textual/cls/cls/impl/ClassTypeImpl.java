...
public class ClassTypeImpl extends TypeImpl implements ClassType
{
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClsPackage.CLASS_TYPE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(ClassName newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClsPackage.CLASS_TYPE__TYPE, oldType, type));
  }
