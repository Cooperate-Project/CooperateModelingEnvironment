...
public class ImplementationImpl extends ConnectorImpl implements Implementation
{
  ...
  {
    return (AssociationEnd)eDynamicGet(ClsPackage.IMPLEMENTATION__RIGHT, ClsPackage.Literals.IMPLEMENTATION__RIGHT, true, true);
  }
  ...
  {
    msgs = eDynamicInverseAdd((InternalEObject)newRight, ClsPackage.IMPLEMENTATION__RIGHT, msgs);
    return msgs;
  }
  ...
  {
    eDynamicSet(ClsPackage.IMPLEMENTATION__RIGHT, ClsPackage.Literals.IMPLEMENTATION__RIGHT, newRight);
  }
