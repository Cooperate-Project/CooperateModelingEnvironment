 ...
 * @generated
 */
public class ImplementationImpl extends ConnectorImpl implements Implementation
{
  /**
  ...
  public NotificationChain basicSetRight(AssociationEnd newRight, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ClsPackage.IMPLEMENTATION__RIGHT, oldRight, newRight);
  ...
  public void setRight(AssociationEnd newRight)
  {
    if (newRight != right)
    {
      ...
      if (right != null)
        msgs = ((InternalEObject)right).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ClsPackage.IMPLEMENTATION__RIGHT, null, msgs);
      if (newRight != null)
        msgs = ((InternalEObject)newRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ClsPackage.IMPLEMENTATION__RIGHT, null, msgs);
      msgs = basicSetRight(newRight, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ClsPackage.IMPLEMENTATION__RIGHT, newRight, newRight));
  }
