...
public class ClsGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class AttributeElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cTypeTypeFQNParserRuleCall_6_0_1 = (RuleCall)cTypeTypeCrossReference_6_0.eContents().get(1);
		
		//Attribute:
		//	{Attribute} visibility=Visibility?
		//	static?='static'?
		//	final?='final'?
		//	referencedElement=[uml::Property] ':' type=[uml::Type|FQN];
		@Override public ParserRule getRule() { return rule; }
		...
		//FQN
		public RuleCall getTypeTypeFQNParserRuleCall_6_0_1() { return cTypeTypeFQNParserRuleCall_6_0_1; }
	}
	...
	public class MethodElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cTypeTypeFQNParserRuleCall_8_1_0_1 = (RuleCall)cTypeTypeCrossReference_8_1_0.eContents().get(1);
		...
		//(parameters+=Parameter (',' parameters+=Parameter)*)* ')' (':' type=[uml::Type|FQN])?
		public Group getGroup() { return cGroup; }
		...
		//FQN
		public RuleCall getTypeTypeFQNParserRuleCall_8_1_0_1() { return cTypeTypeFQNParserRuleCall_8_1_0_1; }
	}
	...
	public class ParameterElements extends AbstractParserRuleElementFinder {
		...
		//	static?='static'?
		//	final?='final'?
		//	referencedElement=[uml::Parameter] ':' type=[uml::Type|FQN];
		@Override public ParserRule getRule() { return rule; }

		//visibility=Visibility? static?='static'? final?='final'? referencedElement=[uml::Parameter] ':' type=[uml::Type|FQN]
		public Group getGroup() { return cGroup; }
	...
	public class AssociationElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cAlternatives_3 = (Alternatives)cGroup.eContents().get(3);
		private final Assignment cReferencedElementAssignment_3_0 = (Assignment)cAlternatives_3.eContents().get(0);
		private final CrossReference cReferencedElementAssociationCrossReference_3_0_0 = (CrossReference)cReferencedElementAssignment_3_0.eContents().get(0);
		private final RuleCall cReferencedElementAssociationIDTerminalRuleCall_3_0_0_1 = (RuleCall)cReferencedElementAssociationCrossReference_3_0_0.eContents().get(1);
		private final Assignment cReferencedElementAssignment_3_1 = (Assignment)cAlternatives_3.eContents().get(1);
		private final CrossReference cReferencedElementAssociationCrossReference_3_1_0 = (CrossReference)cReferencedElementAssignment_3_1.eContents().get(0);
		private final RuleCall cReferencedElementAssociationNameStringParserRuleCall_3_1_0_1 = (RuleCall)cReferencedElementAssociationCrossReference_3_1_0.eContents().get(1);
		...
		//Association:
		//	bidirectional?='bi'? aggregationKind=AggregationKind left=[uml::Classifier|FQN] (referencedElement=[uml::Association]
		//	| referencedElement=[uml::Association|NameString]) right=[uml::Classifier|FQN] properties=AssociationProperties?
		//	('note' comment=[uml::Comment|CommentBody])?;
		@Override public ParserRule getRule() { return rule; }

		//bidirectional?='bi'? aggregationKind=AggregationKind left=[uml::Classifier|FQN] (referencedElement=[uml::Association] |
		//referencedElement=[uml::Association|NameString]) right=[uml::Classifier|FQN] properties=AssociationProperties? ('note'
		//comment=[uml::Comment|CommentBody])?
		public Group getGroup() { return cGroup; }
		...
		//(referencedElement=[uml::Association] | referencedElement=[uml::Association|NameString])
		public Alternatives getAlternatives_3() { return cAlternatives_3; }

		//referencedElement=[uml::Association]
		public Assignment getReferencedElementAssignment_3_0() { return cReferencedElementAssignment_3_0; }

		//[uml::Association]
		public CrossReference getReferencedElementAssociationCrossReference_3_0_0() { return cReferencedElementAssociationCrossReference_3_0_0; }

		//ID
		public RuleCall getReferencedElementAssociationIDTerminalRuleCall_3_0_0_1() { return cReferencedElementAssociationIDTerminalRuleCall_3_0_0_1; }

		//referencedElement=[uml::Association|NameString]
		public Assignment getReferencedElementAssignment_3_1() { return cReferencedElementAssignment_3_1; }

		//[uml::Association|NameString]
		public CrossReference getReferencedElementAssociationCrossReference_3_1_0() { return cReferencedElementAssociationCrossReference_3_1_0; }

		//NameString
		public RuleCall getReferencedElementAssociationNameStringParserRuleCall_3_1_0_1() { return cReferencedElementAssociationNameStringParserRuleCall_3_1_0_1; }
	...
	public class MultiAssociationElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cReferencedElementAssignment_1_0 = (Assignment)cAlternatives_1.eContents().get(0);
		private final CrossReference cReferencedElementAssociationCrossReference_1_0_0 = (CrossReference)cReferencedElementAssignment_1_0.eContents().get(0);
		private final RuleCall cReferencedElementAssociationIDTerminalRuleCall_1_0_0_1 = (RuleCall)cReferencedElementAssociationCrossReference_1_0_0.eContents().get(1);
		private final Assignment cReferencedElementAssignment_1_1 = (Assignment)cAlternatives_1.eContents().get(1);
		private final CrossReference cReferencedElementAssociationCrossReference_1_1_0 = (CrossReference)cReferencedElementAssignment_1_1.eContents().get(0);
		private final RuleCall cReferencedElementAssociationNameStringParserRuleCall_1_1_0_1 = (RuleCall)cReferencedElementAssociationCrossReference_1_1_0.eContents().get(1);
		private final Keyword cLeftCurlyBracketKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Group cGroup_3 = (Group)cGroup.eContents().get(3);
		...
		//MultiAssociation:
		//	'asc' (referencedElement=[uml::Association] | referencedElement=[uml::Association|NameString]) '{'
		...
		//referencedElement=[uml::Association]
		public Assignment getReferencedElementAssignment_1_0() { return cReferencedElementAssignment_1_0; }

		//[uml::Association]
		public CrossReference getReferencedElementAssociationCrossReference_1_0_0() { return cReferencedElementAssociationCrossReference_1_0_0; }

		//ID
		public RuleCall getReferencedElementAssociationIDTerminalRuleCall_1_0_0_1() { return cReferencedElementAssociationIDTerminalRuleCall_1_0_0_1; }

		//referencedElement=[uml::Association|NameString]
		public Assignment getReferencedElementAssignment_1_1() { return cReferencedElementAssignment_1_1; }

		//[uml::Association|NameString]
		public CrossReference getReferencedElementAssociationCrossReference_1_1_0() { return cReferencedElementAssociationCrossReference_1_1_0; }

		//NameString
		public RuleCall getReferencedElementAssociationNameStringParserRuleCall_1_1_0_1() { return cReferencedElementAssociationNameStringParserRuleCall_1_1_0_1; }
	...
	public class MemberEndElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cTypeClassifierCrossReference_0_0 = (CrossReference)cTypeAssignment_0.eContents().get(0);
		private final RuleCall cTypeClassifierFQNParserRuleCall_0_0_1 = (RuleCall)cTypeClassifierCrossReference_0_0.eContents().get(1);
		private final Assignment cReferencedElementAssignment_1 = (Assignment)cGroup.eContents().get(1);
		...
		//[uml::Classifier|FQN]
		public CrossReference getTypeClassifierCrossReference_0_0() { return cTypeClassifierCrossReference_0_0; }

		//FQN
		public RuleCall getTypeClassifierFQNParserRuleCall_0_0_1() { return cTypeClassifierFQNParserRuleCall_0_0_1; }
