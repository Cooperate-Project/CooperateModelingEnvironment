...
public class FocusManagerTextual extends FocusManagerBase<XtextEditor> {
    ...
    public IFile getCooperateLauncherFile() {
        ...
        if (editorInput instanceof CooperateCDOLobEditorInput) {
            return ((CooperateCDOLobEditorInput) editorInput).getAssociatedLauncherFile();
        }
    ...
    public Optional<CDOView> getCDOView() {
        IEditorInput editorInput = getEditorPart().getEditorInput();
        if (editorInput instanceof CooperateCDOLobEditorInput) {
            return Optional.ofNullable(((CooperateCDOLobEditorInput) editorInput).getResource().cdoView());
        }
        return Optional.empty();
    }
    ...
    public Optional<DiagramTypes> getDiagramType() {
        IEditorInput editorInput = getEditorPart().getEditorInput();
        if (editorInput instanceof CooperateCDOLobEditorInput) {
            CDOResourceLeaf resource = ((CooperateCDOLobEditorInput) editorInput).getResource();
