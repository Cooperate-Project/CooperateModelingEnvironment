...
import de.cooperateproject.modeling.textual.sequence.ide.contentassist.antlr.PartialSequenceContentAssistParser;
...
import de.cooperateproject.modeling.textual.sequence.ui.cdoxtext.SequenceDistanceFunction;
import de.cooperateproject.modeling.textual.sequence.ui.cdoxtext.SequenceMatchEngineFactory;
import de.cooperateproject.modeling.textual.sequence.ui.contentassist.SequenceProposalProvider;
import de.cooperateproject.modeling.textual.sequence.ui.labeling.SequenceDescriptionLabelProvider;
import de.cooperateproject.modeling.textual.sequence.ui.labeling.SequenceLabelProvider;
...
/**
 * Manual modifications go to {@link SequenceUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractSequenceUiModule extends DefaultUiModule {

	public AbstractSequenceUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(de.cooperateproject.modeling.textual.sequence.parser.antlr.internal.InternalSequenceLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalSequenceLexer.class).toProvider(LexerProvider.create(InternalSequenceLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return SequenceLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(SequenceDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return SequenceOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return SequenceQuickfixProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialSequenceContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Sequence Compare");
	}
	...
	public Class<? extends Factory> bindFactory() {
		return SequenceMatchEngineFactory.class;
	}
