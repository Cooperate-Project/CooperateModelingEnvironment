		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUseCaseDiagramAccess().getRootPackageAssignment_1(), "rule__UseCaseDiagram__RootPackageAssignment_1");
					...
					put(grammarAccess.getGeneralizationAccess().getClientAssignment_0(), "rule__Generalization__ClientAssignment_0");
					put(grammarAccess.getGeneralizationAccess().getSupplierAssignment_2(), "rule__Generalization__SupplierAssignment_2");
					put(grammarAccess.getIncludeAccess().getClientAssignment_0(), "rule__Include__ClientAssignment_0");
					put(grammarAccess.getIncludeAccess().getSupplierAssignment_2(), "rule__Include__SupplierAssignment_2");
					put(grammarAccess.getExtendAccess().getClientAssignment_0(), "rule__Extend__ClientAssignment_0");
					put(grammarAccess.getExtendAccess().getSupplierAssignment_2(), "rule__Extend__SupplierAssignment_2");
					put(grammarAccess.getExtendAccess().getExtensionPointAssignment_4(), "rule__Extend__ExtensionPointAssignment_4");
