		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getActorAccess().getAliasAssignment_3_1_0(), "rule__Actor__AliasAssignment_3_1_0");
					put(grammarAccess.getActorAccess().getNameAssignment_3_1_2(), "rule__Actor__NameAssignment_3_1_2");
					...
					put(grammarAccess.getUseCaseAccess().getAliasAssignment_3_1_0(), "rule__UseCase__AliasAssignment_3_1_0");
					put(grammarAccess.getUseCaseAccess().getNameAssignment_3_1_2(), "rule__UseCase__NameAssignment_3_1_2");
					...
					put(grammarAccess.getExtensionPointAccess().getAliasAssignment_1_1_0(), "rule__ExtensionPoint__AliasAssignment_1_1_0");
					put(grammarAccess.getExtensionPointAccess().getNameAssignment_1_1_2(), "rule__ExtensionPoint__NameAssignment_1_1_2");
