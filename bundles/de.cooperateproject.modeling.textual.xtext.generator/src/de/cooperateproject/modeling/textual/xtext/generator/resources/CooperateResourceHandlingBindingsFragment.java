...
public class CooperateResourceHandlingBindingsFragment extends Xtend2GeneratorFragment {
    ...
    public Set<Binding> getGuiceBindingsUi(Grammar grammar) {
        return new BindFactory()
                .addTypeToType("org.eclipse.xtext.ui.editor.model.XtextDocument",
                        "de.cooperateproject.modeling.textual.xtext.runtime.editor.CooperateXtextDocument")
                .addTypeToType("org.eclipse.xtext.ui.editor.model.XtextDocumentProvider",
                        "de.cooperateproject.modeling.textual.xtext.runtime.editor.CooperateCDOXtextDocumentProvider")
                .addTypeToType("org.eclipse.xtext.ui.resource.IResourceSetProvider",
    ...
    public Set<Binding> getGuiceBindingsRt(Grammar grammar) {
        return new BindFactory()
                .addTypeToType("org.eclipse.xtext.resource.XtextResourceSet",
                        "de.cooperateproject.modeling.textual.xtext.runtime.resources.CooperateResourceSet")
                .addTypeToType("org.eclipse.xtext.scoping.IGlobalScopeProvider",
                        "de.cooperateproject.modeling.textual.xtext.runtime.scoping.CooperateGlobalScopeProvider")
                .addTypeToType("de.cooperateproject.modeling.textual.xtext.runtime.scoping.IUMLUriFinder",
                        "de.cooperateproject.modeling.textual.xtext.runtime.scoping.ConventionalUMLUriFinder")
                .addTypeToType(
                        "de.cooperateproject.modeling.textual.xtext.runtime.editor.IDerivedStateResourceHandlerFactory",
                        "de.cooperateproject.modeling.textual.xtext.runtime.editor.DerivedStateResourceHandlerFactory")
                .getBindings();
    }
