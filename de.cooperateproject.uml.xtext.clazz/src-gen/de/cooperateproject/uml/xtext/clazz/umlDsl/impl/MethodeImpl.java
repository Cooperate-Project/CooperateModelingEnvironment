 ...
 * </p>
 * <ul>
 *   <li>{@link de.cooperateproject.uml.xtext.clazz.umlDsl.impl.MethodeImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodeImpl extends MemberImpl implements Methode
{
  ...
  {
    return UmlDslPackage.Literals.METHODE;
  }
  ...
  public EList<Attribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, UmlDslPackage.METHODE__ATTRIBUTES);
    }
    return attributes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UmlDslPackage.METHODE__ATTRIBUTES:
